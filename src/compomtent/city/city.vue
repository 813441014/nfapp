<template>
    <div  class="moleDiv" @click="dissmissAlert">
        ...
        <div class="moleAlert" @click.stop="kong">
            ...
            <div v-else  class="nowLocation">
               <p class="leftdiv" @click="dismiss()">取消</p>
               <p class="right_sure" @click="confirm()">确定</p>
            </div>
    ...
    export default {
        ...
        data(){
            return{
                ...
                columns:[{
                    ...
                    "values": ["东城区", "西城区", "崇文区", "宣武区", "朝阳区", "丰台区", "石景山区", "海淀区", "门头沟区", "房山区", "通州区", "顺义区", "昌平区", "大兴区", "怀柔区", "平谷区", "密云县", "延庆县", "其它区"],
                    "className": "name1"
                }],
                province_list:[{
                    "region_id": "2",
                ...
                columns_province:["北京","天津","河北省","山西省","内蒙古自治区","辽宁省","吉林省","黑龙江省","上海","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西壮族自治区","海南省","重庆","四川省","贵州省","云南省","西藏自治区","陕西省","甘肃省","青海省","宁夏回族自治区","新疆维吾尔自治区","台湾","香港特别行政区","澳门特别行政区","海外"],
                columns_city:["北京市"],
                columns_couny:["东城区", "西城区", "崇文区", "宣武区", "朝阳区", "丰台区", "石景山区", "海淀区", "门头沟区", "房山区", "通州区", "顺义区", "昌平区", "大兴区", "怀柔区", "平谷区", "密云县", "延庆县", "其它区"],
                id01:2,
                id02:37,
                id03:403,
                index01:0,
        ...
        methods:{
            ...
            confirm(){
                ...
                this.$set(this.selId,"area_name",this.county_list[this.id02][this.index03].region_name);
                ...
                this.$set(this.selId,"address",this.selCity );
                 this.$set(this.selId,"city_name",this.county_list[this.id02][this.index03].region_name);
                this.$emit("confirmSure",this.selId)
            },
            pickIndex(id){
                var id01 = this.id01;
                var id02= "";
